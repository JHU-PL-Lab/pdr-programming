...
module Asttypes = struct
  let pp_label formatter s = Format.pp_print_string formatter s;;
  ...
  type 'a loc = 'a Location.loc = {
    txt : 'a;
    loc : Location.t; [@printer fun _ _ -> ()]
  }
  [@@deriving show]
...
let pp_location formatter _ = Format.pp_print_string formatter "<loc>";;
...
and package_type = Longident.t loc * (Longident.t loc * core_type) list
      ...
      (*
        (module S)
        (module S with type t1 = T1 and ... and tn = Parsetree.tn = Tn)
       *)
...
and expression_desc = Parsetree.expression_desc =
  ...
  *)
  ...
  (* let P1 = E1 and ... and Pn = Parsetree.Pn = EN in E       (flag = Nonrecursive)
     let rec P1 = E1 and ... and Pn = Parsetree.Pn = EN in E   (flag = Recursive)
  *)
...
and class_description = Parsetree.class_description
    [@printer pp_class_infos pp_class_type]


and class_type_declaration = Parsetree.class_type_declaration
    [@printer pp_class_infos pp_class_type]
...
and class_expr_desc = Parsetree.class_expr_desc =
  ...
  *)
  ...
  (* let P1 = E1 and ... and Pn = Parsetree.Pn = EN in CE      (flag = Nonrecursive)
     let rec P1 = E1 and ... and Pn = Parsetree.Pn = EN in CE  (flag = Recursive)
  *)
...
and class_declaration = Parsetree.class_declaration
    [@printer pp_class_infos pp_class_expr]
...
and signature_item_desc = Parsetree.signature_item_desc =
  ...
  (* type t1 = ... and ... and tn = Parsetree.tn = ... *)
  ...
  (* class type ct1 = ... and ... and ctn = Parsetree.ctn = ... *)
...
and include_description = Parsetree.include_description
    [@printer pp_include_infos pp_module_type]

(* include MT *)

and include_declaration = Parsetree.include_declaration
    [@printer pp_include_infos pp_module_expr]
...
and structure = Parsetree.structure
    [@printer Jhupllib.Pp_utils.pp_list pp_structure_item]
...
and structure_item_desc = Parsetree.structure_item_desc =
  ...
  (* let P1 = E1 and ... and Pn = Parsetree.Pn = EN       (flag = Nonrecursive)
     let rec P1 = E1 and ... and Pn = Parsetree.Pn = EN   (flag = Recursive)
  *)
  ...
  (* module rec X1 = ME1 and ... and Xn = Parsetree.Xn = MEn *)
  | Pstr_modtype of module_type_declaration
  (* module type S = MT *)
  | Pstr_open of open_description
  (* open X *)
  | Pstr_class of class_declaration list
  (* class c1 = ... and ... and cn = Parsetree.cn = ... *)
